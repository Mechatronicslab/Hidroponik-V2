...
public class DeviceInfo {
    ...
    private class CachedInfo {
        ...
        private CachedInfo() throws IOException {
        ...
        private String getCountryFromLocation() throws IOException {
        ...
        private String getAndCacheAmazonAdvertisingId() {
            ...
            limitAdTrackingEnabled = Settings.Secure.getInt(cr, SETTING_LIMIT_AD_TRACKING, 0) == 1;
            advertisingId = Settings.Secure.getString(cr, SETTING_ADVERTISING_ID);
        ...
        private String getAndCacheGoogleAdvertisingId() {
            try {
                ...
                Log.e(TAG, "Google Play Services SDK not found!");
        ...
        private boolean checkGPSEnabled() {
            ...
            try {
                ...
                Log.e(TAG, "Google Play Services Util not found!");
            } catch (ClassNotFoundException e) {
                Log.e(TAG, "Google Play Services Util not found!");
    ...
    private CachedInfo getCachedInfo() throws IOException {
        if (cachedInfo == null) {
    ...
    public String getOsVersion() throws IOException {
    ...
    public String getCarrier() throws IOException {
    ...
    public String getAdvertisingId() throws IOException {
        return getCachedInfo().advertisingId;
    }

    public boolean isLimitAdTrackingEnabled() throws IOException {
